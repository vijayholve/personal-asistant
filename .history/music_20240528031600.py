...
def play_music(music):
    ...
    pygame.mixer.music.load("c:/Users/Vijay/Pictures/MERN_VIJAY/09. HTML (Level - 3)/05. Forms in HTML.mp4")
...
def music_main():
    ...
    # print("replaced",file)
    play_music("c:/Users/Vijay/Pictures/MERN_VIJAY/09. HTML (Level - 3)/05. Forms in HTML.mp4")
